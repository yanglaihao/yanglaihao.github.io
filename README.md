...
页面已按学校团队主页的宽版结构优化：研究方向使用可点击切换的可播放视频模块，团队成员改为分组点击展开，团队成果改为“成果简介 + 项目/论文/专利/专著/获奖/社会任职板块”，项目默认优先展示，获奖按学校主页分类展示，首页导航支持中英文切换并覆盖全页面可见文字，团队动态按亮点工作 / 新闻 / 通知区分展示，联系区包含团队主页二维码。
