...
英文成果页已使用专用成果条目翻译逻辑，覆盖项目、论文、国际专利、中国专利、专著、获奖和社会任职等可见条目，避免回退为 `Publication (year)`、`Patent (year)` 等占位文案。
...
- 论文列表参考 Google Scholar 与 ResearchGate 主页链接，并结合学校论文页、ORCID、知网保存页与公开 DOI 信息交叉整理；页面内按 SCI 期刊、EI 期刊、EI 会议、预印本和其他论文分类展示 95 篇代表性论文；“其他论文”中删除 2022 年两条错误记录。
...
- 团队动态按杨来浩、孙瑜教师主页、媒体报道、受邀讲座报道及用户提供海报更新为 3 条亮点报道、15 条新闻、4 条通知，并补齐英文翻译。
