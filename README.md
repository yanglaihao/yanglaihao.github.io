...
页面已按学校团队主页的宽版结构优化：研究方向使用可点击切换的可播放视频模块，团队成员改为分组点击展开，团队成果改为“成果简介 + 项目/论文/专利/专著/获奖/社会任职板块”，项目默认优先展示，获奖按学校主页分类展示，首页导航支持中英文切换并覆盖全页面可见文字，团队动态按新闻 / 通知区分展示，联系区包含团队主页二维码。
...
- 专利列表按本地保存的 Google Patents 与中国知网页面更新：国际专利 8 条；中国专利按四个知网保存页去重整理为 96 条，其中 52 条发明授权、44 条发明公开，并在条目中标注公开 / 授权状态。同一专利若已有授权号，仅保留授权信息。
- 团队动态按杨来浩、孙瑜教师主页及可核验外链更新为 10 条新闻、4 条通知，并补齐英文翻译。
