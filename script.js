...
const translations = {
  zh: {
    ...
    "nav.contact": "联系方式",
    "hero.title": "非攻机器人实验室",
    "hero.subtitle": "取“非攻”一器多形之巧，造因境而变、入微而作的智能检修机器人。实验室面向航空发动机等高端装备内部深腔、狭窄通道和复杂曲面损伤，发展智能诊断、原位介入与具身操作机器人，让装备维护从大拆大修走向少拆解、少损伤、少停机的在位微创处置。",
...
const textTranslations = {
  ...
  "实验室简介": "About the Lab",
  "团队简介": "About the Team",
  "取“非攻”一器多形之巧，造因境而变、入微而作的智能检修机器人。实验室面向航空发动机等高端装备内部深腔、狭窄通道和复杂曲面损伤，发展智能诊断、原位介入与具身操作机器人，让装备维护从大拆大修走向少拆解、少损伤、少停机的在位微创处置。": "Inspired by Feigong's ingenuity of one device taking many forms, the lab builds intelligent maintenance robots that adapt to their environment and work at fine scale. The lab develops robots for intelligent diagnosis, in-situ intervention, and embodied manipulation in deep cavities, narrow passages, and damaged complex surfaces inside aero-engines and other advanced equipment, moving maintenance from major disassembly toward in-situ minimally invasive work with less disassembly, less damage, and less downtime.",
  ...
  "非攻机器人实验室依托西安交通大学机械工程学院和航空发动机研究所，取“非攻”一器多形之巧，造因境而变、入微而作的智能检修机器人。实验室将“一器多形、因境而变、入微而作”的机构学寓意转化为高端装备智能检修能力：面向航空发动机、燃机、航天器等复杂装备内部深腔、狭窄通道、遮挡区域和复杂曲面损伤，发展可重构、柔顺、可感知、可操作的机器人系统，围绕智能诊断、原位介入、具身操作三条主线，让机器人在装备内部看得清、进得去、稳得住、修得准，以尽量少拆解、少损伤、少停机的方式完成在位诊断、进入和维护。": "Feigong Robotics Laboratory is based in the School of Mechanical Engineering and the Aero-engine Research Institute at Xi'an Jiaotong University. Taking the ingenuity of Feigong as one device with many forms, the lab builds intelligent maintenance robots that adapt to their environment and work at fine scale. It translates the mechanism ideas of multi-form structure, environment-responsive adaptation, and fine-scale operation into intelligent maintenance capabilities for advanced equipment: reconfigurable, compliant, perceptive, and operable robotic systems for deep cavities, narrow passages, occluded regions, and complex-surface damage inside aero-engines, gas turbines, spacecraft, and other complex equipment. The lab focuses on intelligent diagnosis, in-situ intervention, and embodied manipulation so robots can perceive, enter, stabilize, and repair inside equipment with as little disassembly, damage, and downtime as possible.",
  ...
  "来源：孙瑜老师主页学生信息": "Source: Prof. Yu Sun Faculty Homepage Student Information",
  "王昊": "Hao Wang",
  "韩天瑞": "Tianrui Han",
  "李芷源": "Zhiyuan Li",
  "唐鑫": "Xin Tang",
  ...
  "来源：孙瑜老师主页桃李天下": "Source: Prof. Yu Sun Faculty Homepage Alumni",
  "团队成果": "Team Outputs",
