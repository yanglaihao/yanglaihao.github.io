...
const translations = {
  zh: {
    "meta.description": "西安交通大学非攻机器人实验室，面向航空发动机等高端装备，发展少拆解、少损伤、少停机的在位智能检修机器人。",
    ...
    "nav.contact": "联系方式",
    "hero.title": "非攻机器人实验室",
    "hero.subtitle": "“非攻”取意于百度百科《非攻》词条中兼具机构学和机器人意味的器物意象。实验室面向航空发动机等高端装备内部深腔、狭窄通道和复杂曲面损伤，发展智能诊断、原位介入与具身操作机器人，让装备维护从大拆大修走向少拆解、少损伤、少停机的在位微创处置。",
  ...
  en: {
    "meta.description": "Feigong Robotics Laboratory at Xi'an Jiaotong University develops in-situ intelligent maintenance robots for advanced equipment with less disassembly, less damage, and less downtime.",
...
const textTranslations = {
  ...
  "实验室简介": "About the Lab",
  "团队简介": "About the Team",
  "“非攻”取意于百度百科《非攻》词条中兼具机构学和机器人意味的器物意象。实验室面向航空发动机等高端装备内部深腔、狭窄通道和复杂曲面损伤，发展智能诊断、原位介入与具身操作机器人，让装备维护从大拆大修走向少拆解、少损伤、少停机的在位微创处置。": "\"Feigong\" is taken from the Baidu Baike entry as an artifact image with mechanism and robotics connotations. The lab develops robots for intelligent diagnosis, in-situ intervention, and embodied manipulation in deep cavities, narrow passages, and damaged complex surfaces inside aero-engines and other advanced equipment, moving maintenance from major disassembly toward in-situ minimally invasive work with less disassembly, less damage, and less downtime.",
  ...
  "非攻机器人实验室依托西安交通大学机械工程学院和航空发动机研究所。“非攻”取自百度百科《非攻》词条中兼具机关构型与机器人意味的器物意象：多形态机构、攻守转换、藏锋守护、以巧制胜。实验室将这种机构学意象映射到高端装备智能检修中，发展可重构、柔顺、可进入狭窄深腔的机器人系统，让机器人在复杂装备内部看得清、进得去、稳得住、修得准，以尽量少拆解、少损伤、少停机的方式完成高端装备在位诊断、进入和维护。": "Feigong Robotics Laboratory is based in the School of Mechanical Engineering and the Aero-engine Research Institute at Xi'an Jiaotong University. \"Feigong\" is drawn from the Baidu Baike entry as an artifact image with mechanism and robotics connotations: multi-form mechanisms, switching between operation and protection, concealed capability, and winning through ingenuity. The lab maps this mechanism image to intelligent maintenance of advanced equipment by developing reconfigurable, compliant robots that can enter narrow deep cavities, perceive clearly, access reliably, stabilize, and repair precisely with less disassembly, less damage, and less downtime.",
  ...
  "名称来源": "Name Origin",
  "取自百度百科《非攻》词条的机关与机器人意象：一器多形、攻守转换、藏锋守护，指向可重构、柔顺进入和非破坏式检修。": "The name draws on the mechanism and robotics imagery in the Baidu Baike entry for Feigong: one device with multiple forms, switching between operation and protection, and concealed capability, pointing to reconfigurable robots, compliant access, and non-destructive maintenance.",
  "来源链接": "Source",
  ...
  "徐露": "Lu Xu",
  "孙瑜团队": "Yu Sun Team",
  "孙瑜老师团队学生": "Prof. Yu Sun Team Students",
  "根据孙瑜老师学校主页“团队学生”公开信息整理，方向描述保留原页面口径。": "Compiled from the public Team Students page on Prof. Yu Sun's faculty homepage; research directions follow the source wording.",
  "郭庆凯": "Qingkai Guo",
  "汪领": "Ling Wang",
  "梁浩峰": "Haofeng Liang",
  "王韵博": "Yunbo Wang",
  ...
  "金点子选手": "Creative idea contributor",
  "行动力达人": "Action-oriented contributor",
  "求知欲满满": "Strong curiosity and learning drive",
  "控制硬件担当": "Control and hardware contributor",
  "结构设计与系统思维": "Structural design and systems thinking",
  "软体驱动与系统实验": "Soft actuation and system experiments",
  "软体驱动与实验验证": "Soft actuation and experimental validation",
  "智能运维与细致实验": "Intelligent operation and maintenance with careful experimentation",
  "触觉硬件与论文研读": "Tactile hardware and literature study",
  "灵巧操作与机器人手系统": "Dexterous manipulation and robotic hand systems",
  "触觉感知与传感器系统": "Tactile perception and sensor systems",
  "软体驱动与机器人机构": "Soft actuation and robotic mechanisms",
  "来源：孙瑜老师团队学生": "Source: Prof. Yu Sun Team Students",
  "孙瑜老师团队已毕业学生": "Prof. Yu Sun Team Alumni",
  "王昊": "Hao Wang",
  "韩天瑞": "Tianrui Han",
  "李芷源": "Zhiyuan Li",
  "唐鑫": "Xin Tang",
  ...
  "王景 · 硕士 · 2021级 · 航空工业第一飞机设计研究院": "Jing Wang · Master's · 2021 cohort · AVIC First Aircraft Institute",
  ...
  "刘乙雪 · 硕士 · 2022级 · 比亚迪汽车有限公司": "Yixue Liu · Master's · 2022 cohort · BYD Auto Co., Ltd.",
  "来源：孙瑜老师桃李天下": "Source: Prof. Yu Sun Alumni",
  "团队成果": "Team Outputs",
