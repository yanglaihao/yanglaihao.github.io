...
assert.ok(html.includes('href="#welcome" data-i18n="nav.welcome"'), "navigation should include the new welcome page anchor");
assert.ok(html.includes('href="#blog" data-i18n="nav.blog"'), "navigation should include the new Lab Notes page anchor");
assert.ok(html.includes('<section class="section welcome-page" id="welcome"'), "site should include a designed welcome page section");
...
assert.ok(html.includes("招生咨询"), "blog page should include admissions discussion prompts");
assert.ok(html.includes("合作交流"), "blog page should include collaboration discussion prompts");
