...
更新时间：2026-06-20 22:32 CST

本文件已更新到当前项目状态。最新一轮已完成并部署：

- 修正“非攻机器人实验室”立意表达：页面不再出现具体词条出处、来源链接或“名称来源”卡片；简介改为“取‘非攻’一器多形之巧，造因境而变、入微而作的智能检修机器人”，并进一步映射到可重构、柔顺、可感知、可操作的高端装备智能检修机器人，以及智能诊断、原位介入、具身操作三条研究主线。
- 删除团队成员区独立的孙瑜老师学生分组；按用户要求将孙瑜老师公开页面中的 12 名当前学生并入既有“硕士研究生”分组，将 13 名已毕业学生直接并入既有“已毕业”分组，并同步补齐英文页面。
...
教师 / 合作导师分组已加入孙瑜副教授条目，并提供个人主页链接。孙瑜老师公开页面中的 12 名当前学生已并入“硕士研究生”分组，13 名已毕业学生已并入“已毕业”分组；不再设置独立的孙瑜老师学生分组。博士后部分仍为描述性占位，未列出更多姓名。
